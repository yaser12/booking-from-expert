...
#### 2- for user : this project sit will send time in GMT . but befor user show this time: js function will convert it on fly to Time in user local host timezone(I make many js function to make this convertion)
